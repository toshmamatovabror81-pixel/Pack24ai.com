                ...
                {mode === 'telegram' && (
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <div key={step.num} className="flex items-center gap-3">
                                    <span className="w-7 h-7 rounded-full bg-brand-green text-white text-xs font-bold flex items-center justify-center shrink-0">
                                        {step.num}
                                    </span>
                        ...
                        <a
                            ...
                            className="flex items-center justify-center gap-2 w-full bg-brand-green hover:bg-[#053d2e] text-white font-bold py-3 rounded-xl transition-colors"
                        >
